...
<main class="lg:ml-72 min-h-screen p-6">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        <div class="mb-4 flex items-center justify-between flex-wrap gap-3">
            ...
            <div class="flex gap-2">
                <select id="filterKelas" onchange="filterByKelas()" class="px-4 py-2 border border-gray-300 rounded-lg">
                    ...
                    <?php else: ?>
                        <?php foreach ($allSiswa as $i => $s): ?>
                            ...
                            <tr>
                                ...
                                <td><span
                                        class="font-mono bg-gray-100 px-2 py-1 rounded text-sm"><?= htmlspecialchars($s['nisn']) ?></span>
                                </td>
                                <td class="font-semibold"><?= htmlspecialchars($s['nama_lengkap']) ?></td>
                                <td><?= htmlspecialchars($s['nama_kelas'] ?? '-') ?></td>
                                <td>
                                    <span
                                        class="px-2 py-1 rounded-full text-xs font-bold <?= $s['jenis_kelamin'] === 'L' ? 'bg-blue-100 text-blue-700' : 'bg-pink-100 text-pink-700' ?>">
                                        <?= $s['jenis_kelamin'] ?>
                                    </span>
                                </td>
                                <td class="text-center">
                                    ...
                                    <?= $kelengkapan['percentage'] >= 100 ? 'bg-green-100 text-green-700' : ($kelengkapan['percentage'] >= 50 ? 'bg-amber-100 text-amber-700' : 'bg-red-100 text-red-700') ?>">
